...
public class MainActivity extends AppCompatActivity
    ...
    //Tracks whether to display a two-pane or single-pane UI
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.android_me_linear_layout) != null) {
            ...
            //We're in a single-pane mode and displaying fragments on a phone in separate activities
            mTwoPane = false;
        }
    }

    //Define the behavior for onImageSelected
    //This is where we handle fragment communication
    public void onImageSelected(int position) {
        ...
        if (mTwoPane) {
            ...
            //Using a Switch statement we can update the index variables in the onImage callback
            //Set the currently displayed item for the correct body part fragment
            switch (bodyPartNumber) {
                case 0:
                    headIndex = listIndex;
            ...
            //Pass the information to an android activity using an intent
            //Put this information in a Bundle and attach it to an Intent that will launch an AndroidMeActivity
            Bundle b = new Bundle(); //A Bundle is just a set of key value pairs
